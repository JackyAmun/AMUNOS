...
/* AMUNOS 完整保真: 启用全部 DFLAT 功能 (原版 makefile 用 -DBUILD_FULL_DFLAT) */
#define BUILD_FULL_DFLAT
#ifdef BUILD_FULL_DFLAT
#define INCLUDE_MULTI_WINDOWS
/* #define INCLUDE_LOGGING */
/* #define INCLUDE_SHELLDOS -- AMUNOS 无 DOS Shell, 禁用 */
#define INCLUDE_WINDOWOPTIONS
/* #define INCLUDE_PICTUREBOX -- 已删 pictbox.c (无日历/图片框) */
...
#define WITH_ASCIITAB 0

/* AMUNOS 移植: 平台无关头 → libc */
#include <stddef.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
#include "keys.h"
#include "commands.h"
#include "dialbox.h"   /* DBOX/CTLWINDOW, dflat.h 里的对话框原型需要 */
